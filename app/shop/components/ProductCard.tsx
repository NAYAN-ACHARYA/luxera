...
export default function ProductCard({ id, name, cost, image }: ProductCardProps) {
  ...
  return (
    <div
      ...
      className="bg-white rounded-lg p-4 flex flex-col items-center text-center transition-transform transform hover:scale-105 hover:shadow-lg cursor-pointer w-[80%] justify-center"
    >
