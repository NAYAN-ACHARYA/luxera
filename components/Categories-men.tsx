...
export default function WomenCategoryCard() {
  const category = {
    name: "Men",
    image: "/men-transparent.png",
  };

  return (
    <section className="py-0 px-0 w-full mt-[110px] sm:mt-0 font-[Barlow_Condensed]" id='categories'>
